...
sed 's#href="styles#href="new-telegram-script/dashboard/new-telegram-script/dashboard/styles#g' dist/my-stock-dashboard/text.html > dist/my-stock-dashboard/index.html
